...
class RetrievePumapayRebillUpdateTransactionReturnTypeTest extends UnitTestCase
{
     ...
     * @throws \Exception
     */
    public function create_from_entity_should_return_a_retrieve_rebill_update_transaction_return_type_when_correct_data_is_provided(): array
    {
        ...
        $transactionReturnType = RetrievePumapayRebillUpdateTransactionReturnType::createFromEntity($transaction);

        $this->assertInstanceOf(RetrievePumapayRebillUpdateTransactionReturnType::class, $transactionReturnType);
     ...
     *
     * @depends create_from_entity_should_return_a_retrieve_rebill_update_transaction_return_type_when_correct_data_is_provided
     * @return void
     */
     ...
     * @return void
     */
    public function it_should_return_provided_status($creationData): void
    {
        [$transaction, $result] = $creationData;
        $this->assertSame((string) $transaction->status(), $result['transaction']['status']);
    }
    ...
    {
        [$transaction, $result] = $creationData;
        $this->assertSame('rebill_update', $result['transaction']['type']);
    }
}
