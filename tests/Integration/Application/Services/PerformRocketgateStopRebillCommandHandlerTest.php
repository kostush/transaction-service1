...
class PerformRocketgateStopRebillCommandHandlerTest extends IntegrationTestCase
{
    /**
     * @var PerformRocketgateStopRebillCommandHandler
     */
    private $handler;
    ...
    public function setUp(): void
    {
        ...
        $this->updateRebillService->method('stop')->willReturn(
        ...
        $this->handler = new PerformRocketgateStopRebillCommandHandler(
    ...
    public function it_should_throw_exception_when_transaction_not_found()
    {
        ...
        $handler = new PerformRocketgateStopRebillCommandHandler(
            new HttpCommandDTOAssembler(),
            $transactionRepositoryMock,
            $this->updateRebillService,
            $biLoggerMock,
    ...
    public function it_should_return_status_declined_when_declined_biller_response_is_provided()
    {
        ...
        $chargeService->method('stop')->willReturn(
