...
class PerformRocketgateStartRebillCommandHandlerTest extends IntegrationTestCase
{
    /**
     * @var PerformRocketgateStartRebillCommandHandler
     */
    private $handler;
    ...
    public function setUp(): void
    {
        ...
        $this->updateRebillService->method('start')->willReturn(
        ...
        $this->handler = new PerformRocketgateStartRebillCommandHandler(
    ...
    public function it_should_throw_exception_when_transaction_not_found()
    {
        ...
        $handler = new PerformRocketgateStartRebillCommandHandler(
            new HttpCommandDTOAssembler(),
            $transactionRepositoryMock,
            $this->updateRebillService,
            $biLoggerMock,
    ...
    public function it_should_return_status_declined_when_declined_biller_response_is_provided()
    {
        ...
        $chargeService->method('start')->willReturn(
