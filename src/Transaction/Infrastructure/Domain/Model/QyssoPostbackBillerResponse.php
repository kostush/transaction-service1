...
/**
 * Class QyssoPostbackBillerResponse
 * @package ProBillerNG\Transaction\Infrastructure\Domain\Model
 */
class QyssoPostbackBillerResponse extends QyssoBillerResponse
{
    /** @var string */
    ...
    protected function __construct(
        ...
        $this->billerTransactionId = $response['trans_id'];
     ...
     */
    public static function create(string $jsonResponse): QyssoPostbackBillerResponse
    {
        ...
        $code = (string) $decodedResponse['reply_code'];

        return new static(
            static::mapStatus($code),
            $code,
            (string) $decodedResponse['reply_desc'],
            null,
            $requestDate,
            $jsonResponse,
            $requestDate
