...
class InvalidCreditCardExpirationDateException extends InvalidPayloadException implements SensitiveInformationException
{
    /**
    ...
    /**
     * InvalidCreditCardExpirationDateException constructor.
     *
