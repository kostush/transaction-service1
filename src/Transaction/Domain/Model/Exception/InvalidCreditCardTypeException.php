...
class InvalidCreditCardTypeException extends InvalidPayloadException implements SensitiveInformationException
{
    /**
    ...
    /**
     * InvalidCreditCardTypeException constructor.
     *
