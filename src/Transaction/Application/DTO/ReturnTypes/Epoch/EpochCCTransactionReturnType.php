...
class EpochCCTransactionReturnType extends TransactionReturnType
{
    /**
     * @var string
     */
     ...
     * @param int                $cardExpirationMonth The card expiration month
     * @param int                $cardExpirationYear  The card expiration month
     ...
     * @return EpochCCTransactionReturnType
     */
