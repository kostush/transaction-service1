...
class PerformRocketgateUpdateRebillCommandHandler extends BaseCommandHandler
{
    ...
    public function execute(Command $command)
    {
        try {
            ...
            Log::info('Begin processing update rebill transaction');
            ...
            $event = new RebillUpdateTransactionCreated(
                ...
                RocketGateBillerSettings::ACTION_UPDATE
            );
