...
class PerformNetbillingExistingCreditCardSaleCommandHandler extends BaseCommandHandler
{
    /**
     * @var ChargeService
     */
    ...
    {
        try {
            if (!$command instanceof PerformNetbillingExistingCreditCardSaleCommand) {
                throw new InvalidCommandException(PerformNetbillingExistingCreditCardSaleCommand::class, $command);
            }
            ...
            /** @var NetbillingBillerResponse $billerResponse */
            ...
            list($billerTransactions, $subsequentOperationFields) = RetrieveNetbillingChargeTransactionReturnType::getBillerInteractionsData($transaction);
