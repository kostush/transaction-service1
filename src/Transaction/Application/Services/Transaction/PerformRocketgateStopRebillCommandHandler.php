...
class PerformRocketgateStopRebillCommandHandler extends BaseCommandHandler
{
    ...
    public function execute(Command $command)
    {
        try {
            ...
            Log::info('Begin processing stop rebill transaction');
            ...
            // Create entity
            $transaction = $this->createRocketgateStopRebillTransaction($command, $previousTransaction);

            // Perform suspend
            /** @var RocketgateBillerResponse $billerResponse */
            $billerResponse = $this->updateRebillService->stop($transaction);
            ...
            $event = new RebillUpdateTransactionCreated(
                ...
                RocketGateBillerSettings::ACTION_STOP
            );
